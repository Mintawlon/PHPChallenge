            ...
            <div class="col-sm-10 col-md-8 col-xl-9 mx-xs-2 px-0 mx-auto container">
                ...
                <div class="input_set">
                    ...
                    <div class="input_one mb-2">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="add_file input_set_text">Carousel Image 1</span>
                            </div>
                            <div>
                    ...
                    <div class="input_one mb-2">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="add_file input_set_text">Carousel Image 2</span>
                            </div>
                            <div>
                                <input class="form-control form-control-lg" id="formFileLg" type="file">
                            </div>
                    ...
                    <div class="input_one mb-2">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="add_file input_set_text">Carousel Image 3</span>
                            </div>
                            <div>
                                <input class="form-control form-control-lg" id="formFileLg" type="file">
                            </div>
                    ...
                    <div class="input_one mb-2">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="add_file input_set_text">Carousel Image 4</span>
                            </div>
                            <div>
                                <input class="form-control form-control-lg" id="formFileLg" type="file">
                            </div>
                    ...
                    <div class=" mb-2  ">
                        <!-- Add Btn -->
                        <a href="" class="common_btn add_btn input_box ">Update</a>
                    </div>
                </div>
            </div>
        </div>
